...
export const bestParcel = (intention: Intention, curPos: Position, map: MapConfig, beliefs: BeliefBase, strategy: Strategies) => {
...
export function handlePickup(intention: Intention, beliefs: BeliefBase): {intention: Intention, path: atomicActions[]} {
    ...
    const bestPlanParcel = bestParcel(intention, curPos, map, beliefs, strategy);
