...
exports.MAX_DISTANCE_EXPLORATION = exports.MAX_AGE_EXPLORATION = exports.S_DISTANCE_WEIGHT = exports.S_REWARD_WEIGHT = exports.AGGRESSIVE_DISTANCE_WEIGHT = exports.REWARD_WEIGHT = exports.DISTANCE_WEIGHT = exports.MAX_BLOCK_RETRIES = exports.WAIT_FOR_AGENT_MOVE_ON = exports.EXPLORATION_STEP_TOWARDS_CENTER = void 0;
const config = {
...
exports.EXPLORATION_STEP_TOWARDS_CENTER = 2;
exports.WAIT_FOR_AGENT_MOVE_ON = 1000;
exports.MAX_BLOCK_RETRIES = 3;
exports.DISTANCE_WEIGHT = 1.5;
exports.REWARD_WEIGHT = 1;
exports.AGGRESSIVE_DISTANCE_WEIGHT = 1.17; // should be 1.1 < x < 1.3
exports.S_REWARD_WEIGHT = 0.7;
exports.S_DISTANCE_WEIGHT = 0.5;
exports.MAX_AGE_EXPLORATION = 10000;
exports.MAX_DISTANCE_EXPLORATION = 25;
